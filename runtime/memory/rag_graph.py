...
from agentic_reliability_framework.runtime.memory.models import (
...
from agentic_reliability_framework.core.models import ReliabilityEvent
from agentic_reliability_framework.core.config import config
...
class RAGGraphMemory:
    ...
    def get_graph_stats(self) -> GraphStats:
        ...
        with self._transaction():
            ...
            # Return dict directly (no cast needed)
            return {
