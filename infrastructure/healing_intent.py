...
class IntentStatus(str, Enum):
    ...
    EXECUTING_PARTIAL = "executing_partial"  # Partial execution (multi-step)
    COMPLETED = "completed"  # Enterprise executed successfully
    COMPLETED_PARTIAL = "completed_partial"  # Partially successful
    ...
    OSS_ADVISORY_ONLY = "oss_advisory_only"  # OSS can only advise
    PENDING_APPROVAL = "pending_approval"  # Waiting for human approval
    APPROVED = "approved"  # Human approved
    APPROVED_WITH_OVERRIDES = "approved_with_overrides"  # Approved with changes
...
class HealingIntent:
    ...
    MAX_SIMILAR_INCIDENTS: ClassVar[int] = 20
